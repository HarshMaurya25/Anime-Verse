...
public class EmailValidationSender {
    ...
    private String verificationHtml(NotificationDto dto) {
        return "<!DOCTYPE html>"
                ...
                + "<p style='margin:0 0 14px;color:#cbd5e1;font-size:14px;'>Use the verification code below to complete your signup.</p>"
                ...
                + "<p style='margin:0 0 10px;color:#cbd5e1;font-size:13px;'>This code will expire in 10 minutes.</p>"
