...
public class EmailValidationSender {
    ...
    private String verificationHtml(NotificationDto dto) {
        return "<!DOCTYPE html>"
                ...
                + "<title>Verification code — theOtakuNetwork</title>"
                ...
                + "<div style='display:inline-block;padding:6px 14px;border-radius:999px;background:rgba(225,29,72,0.12);color:#e11d48;font-weight:700;font-size:13px;letter-spacing:0.06em;text-transform:uppercase;'>theOtakuNetwork</div>"
                ...
                + "<p style='margin:0;color:#c6d4e6;font-size:12px'>Need help? Contact <a href='mailto:support@theotakunetwork.example' style='color:#e11d48;text-decoration:none;'>support@theotakunetwork.example</a></p>"
                + "</td></tr>"
                + "<tr><td style='padding:8px 22px 22px;color:#9aa6b2;text-align:center;font-size:12px;'>© theOtakuNetwork — Connect with your anime friends</td></tr>"
    ...
    private String welcomeHtml(NotificationDto dto) {
        ...
        return "<!DOCTYPE html>"
                ...
                + "<meta charset='utf-8'/>"
                + "<meta name='viewport' content='width=device-width, initial-scale=1'/>"
                + "<title>Welcome to theOtakuNetwork</title>"
                + "</head>"
                ...
                + "Welcome to <span style='color:#e11d48'>theOtakuNetwork</span>"
                + "</h1>"
                ...
                + "</p>"
                + "<p style='margin:0 0 12px;font-size:14px;color:#e5d1d6;line-height:1.6;'>"
                + "theOtakuNetwork is a place to discover anime communities, "
                ...
                + "<a href='https://theotakunetwork.example' "
                ...
                + "<a href='mailto:support@theotakunetwork.example' "
                + "style='color:#f43f5e;text-decoration:none;'>"
                + "support@theotakunetwork.example</a>."
                + "<br/><br/>— theOtakuNetwork team"
                + "</td></tr>"
                + "</table></td></tr></table>"
                + "</body></html>";
    }
