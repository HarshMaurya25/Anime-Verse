...
class UsersRepositoryTest {
    ...
    void testFindByIdAndEnableTrue() {
        ...
        Users notFoundUser = usersRepository.findByIdAndEnableTrue(disabledUser.getId());
    ...
    void testFindByIdAndEnableTrueWithFollowers() {
        ...
        Optional<Users> notFoundUser = usersRepository.findByIdAndEnableTrueWithFollowers(disabledUser.getId());
    ...
    void testExistsByIdAndEnableTrue() {
        ...
        boolean disabledExists = usersRepository.existsByIdAndEnableTrue(disabledUser.getId());

        assertThat(exists).isTrue();
        assertThat(disabledExists).isFalse();
    }
    ...
    void testSaveUser() {
        ...
        assertThat(retrievedUser.get().isVerified()).isTrue();
        assertThat(retrievedUser.get().isEnable()).isTrue();
    }
}
