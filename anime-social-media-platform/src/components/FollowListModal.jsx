...
const FollowListModal = ({ isOpen, onClose, type = 'followers', accent, motionSafe }) => {
  ...
  const fetchPage = async (p) => {
    ...
    const endpoint = type === 'following'
      ? `http://localhost:11111/api/profile/user/following/list?id=${encodeURIComponent(cookieUserId)}&page=${p}`
      : `http://localhost:11111/api/profile/user/follower/list?id=${encodeURIComponent(cookieUserId)}&page=${p}`
