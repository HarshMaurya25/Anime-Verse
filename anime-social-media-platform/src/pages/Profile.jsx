...
function Profile() {
  ...
  const handleEditSave = async (payload) => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:11111/api/profile/user/profile/update?id=${encodeURIComponent(uid)}`, {
        method: 'PUT',
        headers: {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:11111/api/profile/user/profile/get?id=${encodeURIComponent(userId)}&image=true`, {
      headers: {
