...
function ProfileSetup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      document.cookie = 'profileCompleted=true; path=/; max-age=604800; SameSite=Lax'
      setApiStatus('success')
      setApiMessage('Profile created successfully! Redirecting...')
            ...
            <div className="relative p-8 sm:p-10">
              ...
              <div className="mt-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {/* Date of Birth */}
                  <div>
                    <label htmlFor="dateOfBirth" className="block text-sm font-medium text-slate-200">Date of Birth <span className="text-rose-400">*</span></label>
                    <div className="relative mt-2">
                      <input
                        type="date"
                        id="dateOfBirth"
