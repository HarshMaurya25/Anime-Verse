...
public interface ContentRepository extends JpaRepository<Content, UUID> {
    ...
    @Query("SELECT cm.content, cm.contentType FROM ContentMedia cm WHERE cm.id = :id")
    Optional<Object[]> getMediaById(@Param("id") UUID id);

    @Query("SELECT cm.id, cm.content, cm.contentType FROM ContentMedia cm WHERE cm.id IN :ids")
    List<Object[]> getMediaByIds(@Param("ids") List<UUID> ids);
